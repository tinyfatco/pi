...
- **`openai-realtime`**: OpenAI Realtime API over WebSocket (`streamOpenAIRealtime`, `OpenAIRealtimeOptions`), including text output and provider-level audio output callbacks
